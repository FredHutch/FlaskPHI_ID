...
setup(
    ...
    install_requires=['amazonserviceinterface',
                      'HutchNERPredict',
                      'flask',
                      'boto3',
                      ],
    ...
    dependency_links = ["https://{}@github.com/FredHutch/ComprehendMedicalInterface/tarball/master#egg=amazonserviceinterface"
